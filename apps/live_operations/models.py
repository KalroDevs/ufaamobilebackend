...
class LiveOnlineClaim(models.Model):
    ...
    processing_date = models.DateField(db_column='Processing Date', blank=True, null=True)
    category = models.CharField(db_column='Category', max_length=50, blank=True, null=True)
    sub_category = models.CharField(db_column='Sub Category', max_length=100, blank=True, null=True)
    agent_name = models.CharField(db_column='Agent Name', max_length=200, blank=True, null=True)
