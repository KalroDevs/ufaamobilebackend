...
class Claim(models.Model):
    ...
    no = models.CharField(
        ...
        db_index=True, 
        blank=True,
        help_text="Claim number generated by mobile app (Format: CLM-{IDENTIFIER}-{TIMESTAMP})"
    )
    ...
    def generate_fallback_claim_number(self):
        ...
        # Clean identifier - keep only alphanumeric characters
        identifier = ''.join(c for c in identifier if c.isalnum()).upper()[:20]
        ...
        claim_no = f"CLM-{identifier}-{timestamp}-{random_suffix}"
